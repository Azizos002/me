...
export function ContactSection() {
  return (
    <section
      id="contact"
      className="relative border-t border-cyan-200/10 px-6 py-24 sm:py-28"
    >
        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <article className="rounded-3xl border border-cyan-100/10 bg-slate-950/45 p-8 backdrop-blur-md sm:p-10">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-slate-100 sm:text-3xl">
              Let&apos;s build resilient, high-impact systems together.
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-300 sm:text-base">
              Open to internships, freelance projects, and technical
              collaborations where software engineering, networks, and
              intelligent systems intersect.
            </p>
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-3">
              {contactMethods.map((method) => (
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-slate-100 truncate">
                    {method.value}
                  </p>
                </a>
              ))}
          ...
          <article className="rounded-3xl border border-cyan-100/10 bg-slate-950/45 p-8 backdrop-blur-md sm:p-10">
            ...
            <form className="mt-6 space-y-3" aria-label="Contact form preview">
              <p className="text-xs uppercase tracking-[0.2em] text-cyan-200/75">
                Quick message (UI preview)
              </p>
              <input
                type="text"
              ...
              <button
                type="button"
                className="w-full rounded-lg border border-cyan-300/35 bg-cyan-500/10 px-4 py-2.5 text-sm font-medium text-cyan-100 transition hover:border-cyan-200 hover:bg-cyan-500/20"
              >
                Send Inquiry
              </button>
            </form>
