...
export function HeroSection() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#02050d] px-6 py-16">
      <NetworkBackground />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center text-center animate-fade-up">
        <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-cyan-300/20 bg-cyan-500/10 px-4 py-1 text-xs uppercase tracking-[0.35em] text-cyan-200/90 md:text-sm">
        ...
        <p className="mt-4 max-w-3xl text-base text-cyan-100/85 sm:text-xl md:text-2xl">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#projects"
            className="rounded-md border border-cyan-300/50 bg-cyan-400/15 px-7 py-3 text-sm font-medium text-cyan-50 transition duration-300 hover:-translate-y-0.5 hover:border-cyan-200 hover:bg-cyan-400/25 hover:shadow-[0_0_30px_rgba(34,211,238,0.35)]"
          >
            View Projects
          </a>
          <a
